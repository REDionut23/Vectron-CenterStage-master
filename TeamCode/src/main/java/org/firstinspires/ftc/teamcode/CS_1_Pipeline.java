...
public class CS_1_Pipeline extends OpenCvPipeline {
   ...
   public static Location location;
    ...
    public CS_1_Pipeline(Telemetry telemetry)
    ...
    public Mat processFrame(Mat input) {
        ...
        double leftValue = Core.sumElems(left).val[2] / LEFT_ROI.area() / 255;
        double centerValue = Core.sumElems(center).val[2] / CENTER_ROI.area() / 255;
